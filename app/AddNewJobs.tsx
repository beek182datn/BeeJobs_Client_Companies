          ...
          onPress: async () => {
            ...
            if (companyId) {
              ...
              if (response.data.data.currency < 19) {
                ...
                const amount = "-19";
                await axios.post(
                  `http://beejobs.io.vn:14307/api/companies/top_up_account/${companyId}`,
                  {
                    amount: Number(amount),
                  }
                );
                await axios.post(
                  "http://beejobs.io.vn:14307/api/payment/confirmPaymentSubtract",
                  {
                    companyId: companyId,
                    amount: Number(amount),
                  }
                ...
                try {
                  ...
                  const response = await axios.post(
                    `http://beejobs.io.vn:14307/api/jobs/create/${companyId}`,
                    addJobs,
                    {
                      headers: {
      ...
      >
        <View style={styles.inputContainer}>
          <Icon
            ...
            size={25}
            style={[styles.icon, styles.iconTitle]}
          />
          <TextInput
            style={[
              styles.input,
        ...
        <View style={styles.inputContainer}>
          <Icon
            name="albums-outline"
            size={25}
            style={[styles.icon, styles.iconForm]}
          />
          <TextInput
            style={[
              styles.input,
        ...
        <View style={styles.inputContainer}>
          <Icon
            name="people-outline"
            size={25}
            style={[styles.icon, styles.iconQuantity]}
          />
          <TextInput
            style={[
              styles.input,
        ...
        <View style={styles.inputContainer}>
          <Icon
            ...
            size={25}
            style={[styles.icon, styles.iconRequirements]}
          />
          <TextInput
            style={[
              styles.input,
              styles.inputRequirements,
        ...
        <View style={styles.inputContainer}>
          <Icon
            name="ribbon"
            size={25}
            style={[styles.icon, styles.iconExperience]}
          />
          <TextInput
            style={[
              styles.input,
              styles.inputExperience,
        ...
        <View style={styles.inputContainer}>
          <Icon
            name="cash-outline"
            size={25}
            style={[styles.icon, styles.iconSalary]}
          />
          <TextInput
            style={[
              styles.input,
        ...
        <View style={styles.inputContainer}>
          <Icon
            name="cash-outline"
            size={25}
            style={[styles.icon, styles.iconWorking_time]}
          />
          <TextInput
            style={[
              styles.input,
              styles.inputWorking_time,
        ...
        <View style={styles.inputContainer}>
          <Icon
            name="gift-outline"
            size={25}
            style={[styles.icon, styles.iconBenefits]}
          />
          <TextInput
            style={[
              styles.input,
              styles.inputBenefits,
        ...
        <View style={styles.inputContainer}>
          <Icon
            ...
            size={25}
            style={[styles.icon, styles.iconDesc]}
          />
          <TextInput
            style={[
              styles.input,
